...
/* El equipo ya no es sección suelta: encabeza «Acerca» y debajo va el resto. */
function teamBlockMarkup(){
  return `<section class="section-block acerca-team">
      <div class="eyebrow">${t("equipo")}</div>
      <h2>${t("teamTitle")}</h2>
      <p class="sub">${t("teamIntro")}</p>
      <div class="team-grid cahe-team-row">${teamCardsMarkup()}</div>
    </section>`;
}
