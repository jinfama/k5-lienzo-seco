...
(function () {
  ...
  function resize() {
    ...
    var minSize = compact ? 132 : 210;
    var vhSize = window.innerHeight * (compact ? 0.24 : 0.38);
    var size = Math.min(container.offsetWidth, Math.max(minSize, Math.min(vhSize, 500)));
